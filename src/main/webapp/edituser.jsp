...
<body style="background-color: #615f5f;">
	<div class="container">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="UserName" value="${userModel.userName}"
			...
			<div class="form-group">
				<label for="FirstName" class="col-sm-3 control-label">FirstName*
				</label>
				<div class="col-sm-9">
					<input type="text" id="FirstName" placeholder="FirstName"
						value="${userModel.firstName}" class="
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="LastName" placeholder="LastName"
						value="${userModel.lastName}" class="form-control">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="FullName" placeholder="FullName"
						value="${userModel.userName}" class="form-control">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="number" id="age" placeholder="age"
						value="${userModel.age}" class="form-control">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="gender" placeholder="gender"
						value="${userModel.gender}" class="form-control">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="Address" placeholder="Address"
						value="${userModel.address}" class="form-control">
				</div>
			</div>
			...
			<button  class="btn btn-primary btn-block"
				onclick="update()">Register</button>
		<!-- /form -->
	</div>
	<!-- ./container -->
</body>
